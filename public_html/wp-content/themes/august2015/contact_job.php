...
<section id="contact2" class="site-content">
    ...
    <div id="about" class="grid grid-pad-nano">
        <div class="col-1-1 nano">
            <div class="overthrow nano-content blur-black">日本、日本国外でお仕事をお探しの方は、セキュリティポリシーに同意の上、下記のボタンよりメールにてお問い合わせ下さい。当社担当者より改めてご連絡させて頂きます。<br/><br/>株式会社エバディ（以下「当社」といいます）は、人材ビジネスを営む企業の責任として、みなさまの個人情報を保護するために細心の注意をはらっています。具体的には、以下の方針に基づき、個人情報の管理・運用を行っていますので、当社の提供する情報サービス（以下、「本サービス」といいます）をご利用いただく前に必ずお読みください。本サービスにおいて個人情報を登録された場合に、当社の個人情報の取扱いに関して同意をいただいたものといたします。
                <br/><br/>
                個人情報とは<br/><br/>
